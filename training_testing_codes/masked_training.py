...
#Paths
IMAGE_DIR = "/kaggle/input/datasets/rishabhjain200407/masked-training/ISIC_2019_masked-20260427T102454Z-3-001/ISIC_2019_masked"
...
CKPT_LOAD_PATH = "/kaggle/input/datasets/rishabhjain200407/masked-checkpoint/masked_ckpt_model.pth"

SAVE_DIR = "/kaggle/working/models"
os.makedirs(SAVE_DIR, exist_ok=True)

CKPT_PATH = f"{SAVE_DIR}/ckpt.pth"
...
train_df[["age_approx"]] = scaler_std.fit_transform(train_df[["age_approx"]])
val_df[["age_approx"]]   = scaler_std.transform(val_df[["age_approx"]])
test_df[["age_approx"]]  = scaler_std.transform(test_df[["age_approx"]])
...
for epoch in range(start_epoch, num_epochs):
    ...
    test_acc, test_f1, test_preds, test_labels = evaluate(test_loader)
